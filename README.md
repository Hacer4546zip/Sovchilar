...
<head>
    ...
    <script>
        document.getElementById('girlLink').addEventListener('click', function(event) {
            event.preventDefault(); // Havolani ochmaslik uchun
            alert('Havola bosildi!');
        });
    </script>
</body>
    <div class="container">
